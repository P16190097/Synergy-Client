...
const Channels = ({ teamName, username, channels, isOwner, users, onAddChannelClick, teamId, onInvitePeopleClick, onDirectMessageClick }) => {
    return (
        <ChannelWrapper>
            <PushLeft>
                <TeamNameHeader>
            ...
            <div>
                <SideBarList>
                    ...
                    <a href="#message-user" onClick={onDirectMessageClick}>
                        + Message Users
                    </a>
                </SideBarList>
            </div>
